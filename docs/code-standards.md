...
- Class Based Views (CBVs) — preferir `DetailView`, `CreateView`, `UpdateView`, `DeleteView`, `LoginView` e mixins nativos do Django.
...
O projeto prioriza recursos nativos do Django. As únicas bibliotecas externas previstas são:
